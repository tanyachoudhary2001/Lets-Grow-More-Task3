...
<nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:150px;">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <p style="margin-left:250px;font-size:40px;color:white;font-style:roboto;">Class 7</p>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin-bottom:-160px;">
            <div class="navbar-nav">
              <button style="margin-right:850px;width:150px;background-color:white;color:red;border-radius:10px;margin-top:-50px;"><a style="margin-left:-10px;color:red;" class="nav-link active" aria-current="page" href="class7addresults.php" style="margin-left:60px;color:yellow;">Add Result</a></button>
                ...
                <div class="table-responsive">
                    <table class="bordered" style="color:white;">
                        ...
                        <?php
                            ...
                            include('links.php');
                            $selectquery = "select * from class7results";
                            ...
                            while($res = mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="7resultupdates.php?id=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="right" title="UPDATE"><i style="color:white;" class="fas fa-pen-square"></i></a></td>
                                    <td><a href="7resultdelete.php?id=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="right" title="DELETE"><i style="color:red;" class="fas fa-trash"></i></a></td>
                                   
                                    <td><form action="7viewresults.php" method="POST">
