...
<html lang="en">
<head>
  <title>Add Results Of Class 7</title>
...
<?php
    ...
    if(isset($_POST['add'])){
        ...
        $insertquery = "insert into class7results(Name,FatherName,English,Hindi,Mathematics,Science,SocialStudies,Total,Status) 
       ...
       if($res){
            ...
            echo "</script>";
            header("Location:a4class7results.php");
       }
       else{
        echo "<script language='javascript'>";
