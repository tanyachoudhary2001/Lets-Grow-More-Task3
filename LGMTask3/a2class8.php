...
<nav class="navbar navbar-expand-lg">
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin-bottom:-160px;">
            <div class="navbar-nav">
              <button style="margin-right:850px;width:150px;background-color:white;color:red;border-radius:10px;margin-top:-50px;"><a style="margin-left:-10px;color:red;" class="nav-link active" aria-current="page" href="a2class8addstudent.php" style="margin-left:60px;color:yellow;">Add Student</a></button>
                ...
                <div class="table-responsive">
                    <table class="bordered" style="color:white;">
                        ...
                        <?php
                            ...
                            include('links.php');
                            $selectquery = "select * from class8";
                            ...
                            while($res = mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="a38update.php?id=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="right" title="UPDATE"><i style="color:white;" class="fas fa-pen-square"></i></a></td>
                                    <td><a href="a38delete.php?id=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="right" title="DELETE"><i style="color:red;" class="fas fa-trash"></i></a></td>
