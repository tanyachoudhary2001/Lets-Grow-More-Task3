...
<html lang="en">
<head>
  <title>Update Results Class 6</title>
...
<form action="#"  method="POST">
        <div class="login-box" style="margin-left:-100px;">
            <h1 style="width:500px;margin-bottom:10px;">Update Details</h1>
            ...
            <?php
                ...
                $showquery = "select * from class6results where id={$ids}";
                ...
                if(isset($_POST['add'])){
                    ...
                    // $insertquery = "insert into addstudent(name,class) values('$name','$class')";

                    $query = " update class6results set id='$ids' , Name='$Name' , FatherName='$FatherName' , English='$English' ,Hindi='$Hindi',Mathematics='$Mathematics' , Science='$Science' , SocialStudies='$SocialStudies' where id='$idupdate' ";

                $res= mysqli_query($con,$query);

                if($res){

                    header("Location:a4class6results.php?message='Updated Successfully!'");
                }
                else{
