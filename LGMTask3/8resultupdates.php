...
<html lang="en">
<head>
  <title>Update Results Class 8</title>
...
<form method="POST">
        <div class="login-box"  style="margin-left:-100px;">
            ...
            <?php
                ...
                $showquery = "select * from class9results where id={$ids}";
                ...
                if(isset($_POST['add'])){
                    ...
                    $query = " update class9results set id='$ids' , Name='$Name', FatherName='$FatherName' , English='$English' ,Hindi='$Hindi',Mathematics='$Mathematics' , Science='$Science' , SocialStudies='$SocialStudies'   where id='$idupdate' ";

                $res= mysqli_query($con,$query);

                if($res){
                    header("Location:a4class8results.php?message='Updated Successfully!'");
                }
                else{
