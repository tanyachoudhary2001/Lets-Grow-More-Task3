      ...
      <nav class="navbar navbar-expand-lg" style="margin-top:-600px;width:300px;color:white;">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup" >
            ...
            <ul class="dropdown-menu" style="background-color:black;font-size:20px;" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="a4class6results.php" style="color:white;">Class 6</a></li>
                <li><a class="dropdown-item" href="a4class7results.php" style="color:white;">Class 7</a></li>
                <li><a class="dropdown-item" href="a4class8results.php" style="color:white;">Class 8</a></li>
            </ul>
            </div>
