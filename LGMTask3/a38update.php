...
<html lang="en">
<head>
  <title>Update Class 8 Students</title>
...
<form action="#" method="POST" style="margin-left:600px;margin-top:60px;">
        <div class="login-box"  style="width:500px;">
            ...
            <?php
                ...
                $showquery = "select * from class8 where id={$ids}";
                ...
                if(isset($_POST['add'])){
                    ...
                    $query = " update class8 set id='$ids' , Name='$Name' ,FatherName='$FatherName',Email='$Email',ContactNo='$ContactNo' where id='$idupdate' ";
