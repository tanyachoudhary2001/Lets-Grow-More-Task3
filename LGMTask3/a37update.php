...
<form action="#" method="POST" style="margin-left:600px;margin-top:60px;">
        <div class="login-box" style="width:500px;">
            ...
            <?php
                ...
                $showquery = "select * from class7 where id={$ids}";
                ...
                if(isset($_POST['add'])){
                    ...
                    $query = " update class7 set id='$ids' , Name='$Name',FatherName='$FatherName',Email='$Email',ContactNo='$ContactNo'  where id='$idupdate' ";
                ...
                if($res){
                        ...
                        header("Location:a2class7.php?message='Updated Successfully!'");
